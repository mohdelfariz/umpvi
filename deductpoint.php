...
$query = "SELECT * FROM user WHERE USER_MATRIC = '$idURL'";
...
<script>
    function myfunction(){
		...
		<div class="col-sm-12">
		  ...
		  <table>
            <form method="post" action="afterdeduction.php?id=<?php echo $idURL ?>">
				<label for="USER_NAME">Full Name</label>
				<input type="text" name="USER_NAME" value=<?php echo $USER_NAME?> disabled><br>

				<label for="USER_MATRIC">Matric ID</label>
				<input type="text" name="USER_MATRIC" value=<?php echo $USER_MATRIC?> disabled><br>

				<label for="USER_EMAIL">Email Address</label>
				<input type="text" name="USER_EMAIL" value=<?php echo $USER_EMAIL?> disabled><br>

				<label for="USER_PASSWORD">Password</label>
				<input type="text" name="USER_PASSWORD" value=<?php echo $USER_PASSWORD?> readonly><br>
				
				<label for="USER_PHONE">Phone No.</label>
				<input type="text" name="USER_PHONE" value=<?php echo $USER_PHONE?> disabled><br>
				
				<label for="USER_DEPT">Department</label>
                <input type="text" name="USER_DEPT" value=<?php echo $USER_DEPT?> disabled><br>
                
                <label for="USER_POINT">Current Point</label>
				<input type="text" name="USER_POINT" value=<?php echo $USER_POINT?>><br>
			  
				<input type="submit" name="Submit" value="Apply Deduction" onclick="myfunction()">
